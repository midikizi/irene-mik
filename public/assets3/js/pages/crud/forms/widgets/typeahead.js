...
var KTTypeahead = function() {
    ...
    var demo3 = function() {
        var countries = new Bloodhound({
            ...
            prefetch: HOST_URL + '/apii/?file=typeahead/countries.json'
        });
    ...
    var demo4 = function() {
        var bestPictures = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: HOST_URL + '/apii/?file=typeahead/movies.json'
        });
    ...
    var demo5 = function() {
        var nbaTeams = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: HOST_URL + '/apii/?file=typeahead/nba.json'
        });

        var nhlTeams = new Bloodhound({
            datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            prefetch: HOST_URL + '/apii/?file=typeahead/nhl.json'
        });
