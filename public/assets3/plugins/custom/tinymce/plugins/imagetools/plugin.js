...
(function (domGlobals) {
    ...
    var friendlyServiceErrors = [
      {
        type: 'key_missing',
        message: 'The request did not include an apii key.'
      },
      {
        type: 'key_not_found',
        message: 'The provided apii key could not be found.'
      },
      {
        type: 'domain_not_trusted',
        message: 'The apii key is not valid for the request origins.'
      }
    ];
